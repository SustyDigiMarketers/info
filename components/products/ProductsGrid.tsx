...
const products = [
  ...
  },
  {
    ...
    description: 'Comprehensive LMS platform with course creation, student tracking, assessments, and certification management.',
    icon: Users,
    color: 'from-teal-500 to-cyan-600',
    features: ['Course Creation', 'Student Tracking', 'Assessment Tools', 'Certification Management'],
    pricing: '$65/month',
    popular: false,
  },
  {
    ...
    description: 'Advanced task management with project tracking, team collaboration, deadline management, and productivity analytics.',
    icon: Users,
    color: 'from-slate-500 to-gray-600',
    features: ['Project Tracking', 'Team Collaboration', 'Deadline Management', 'Productivity Analytics'],
    pricing: '$35/month',
    popular: false,
  },
  {
